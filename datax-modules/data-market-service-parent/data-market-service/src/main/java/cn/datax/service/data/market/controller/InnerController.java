...
public class InnerController extends BaseController {
    ...
    public List<DataApiEntity> getReleaseDataApiList() {
        ...
        List<DataApiEntity> dataApiEntityLisA=new ArrayList<>();
        for (DataApiEntity dataApiEntity : dataApiEntityList) {
            DataApiEntity apiMaskByApiId = dataApiService.getDataApiById(dataApiEntity.getId());
            dataApiEntityLisA.add(apiMaskByApiId);
        }
        return dataApiEntityLisA;
    }
